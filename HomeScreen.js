    ...
    */
    uploadToCloud = async () => {
        if (this.state.imageuri == "") {
            ...
            const gcpToken = "ya29.c.El-lBhfPTDlMMG4McgkW46yMkA-JNn6B4d1c7y8LQtbfTFEdPtWTA-2A7xgnDoyV_Q1g66T2ulOGqfyF-NnXYuJ7vXSEuA619aAnmOptVmo5RbKkDVqeEsV-l7g6bkn8Zw";
            ...
            fetch('https://automl.googleapis.com/v1beta1/projects/qhacks-230509/locations/us-central1/models/ICN1146187338761166163:predict',
                ...
                .then((response) => {
                    ...
                    for(var i = 0; i < t["payload"].length; i++){
                        ...
                        if(t["payload"][i]["displayName"] == 'Wearing_Hat' || t["payload"][i]["displayName"] == 'Wearing_Lipstick' && t["payload"][i]["classification"]["score"] < 0.2){
